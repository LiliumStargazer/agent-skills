...
- **[implement](./implement/SKILL.md)**: Build work from a spec or tickets under the personal engineering standards and Ponytail when available, drive `tdd` at pre-agreed seams, then close with `code-review` before committing.
...
- **[choosing-clear-identifiers](./choosing-clear-identifiers/SKILL.md)**: Choose and review functions, values, types, modules, configuration, and test names for point-of-use clarity.
- **[codebase-design](./codebase-design/SKILL.md)**: Shared discipline and vocabulary for designing deep modules: small interfaces, clean seams, testable through the interface.
- **[structuring-code-modules](./structuring-code-modules/SKILL.md)**: Decide whether code belongs in one file, several cohesive files, or a package with an intentional interface.
- **[code-review](./code-review/SKILL.md)**: Parallel review of a diff since a fixed point across **Standards** (repository rules, personal engineering standards, and Fowler smells), **Spec**, and an optional separate **Ponytail** perspective.
